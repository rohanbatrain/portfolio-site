...
Computer Science Engineering undergraduate (UPES, '27) with hands-on experience across full-stack development, cloud infrastructure, and applied cybersecurity. HACKIITK 2026 finalist at IIT Kanpur (top $\sim$0.4\% of 1,300+ teams) for building Gap Hunter, an offline AI-powered NIST CSF policy gap analyzer. Comfortable shipping production-grade systems end-to-end using Python/FastAPI, AWS, Docker, and security audits across the SDLC.
...
\fontsize{10}{12}\selectfont
\textbf{Cloud, DevOps \& Automation:} AWS (EC2, ECS, S3), Google Cloud, Docker, GitHub Actions, CI/CD, Linux CLI, System Automation \\
\textbf{Software Engineering:} Python, C/C++, JavaScript, SQL, FastAPI, REST APIs, Git \\
\textbf{Security \& Accessibility:} OAuth2, RBAC, OWASP Top 10, SAST/DAST, WCAG 2.0, Cybersecurity Awareness \\
\textbf{AI \& Tooling:} LangChain, Pydantic, Ollama, Redis \\
\textbf{Web \& Mobile:} Hugo, Flutter, Android SDK, HTML, CSS, Responsive Design
...
Organized by C3iHub, IIT Kanpur \textbar{} \href{https://hackiitk.hunterz.in/}{hackiitk.hunterz.in} \\
